...
// router.get('/get-meeting-list-by-week', [authMiddlewares.isAuthentication], meetingController.allMeetingByWeek);
// router.get('/get-meeting-list-by-week-and-room', [authMiddlewares.isAuthentication], meetingController.allMeetingByWeekAndRoom);
// router.get('/get-available-meeting-times-during-day', [authMiddlewares.isAuthentication], meetingController.allAvailableMeetingTime);
// router.get('/get-meeting-list-by-day', [authMiddlewares.isAuthentication], meetingController.allMeetingByDay);
...
router.get('/get-meeting-list-by-week-and-room', meetingController.allMeetingByWeekAndRoom);
